...
import com.doctor.assistant.experiment.czy.poi.excel.annotation.ExcelEntity;
import com.doctor.assistant.experiment.czy.poi.excel.entity.params.ExcelExportEntity;
import com.doctor.assistant.experiment.czy.poi.excel.imports.EasypoiDictServiceI;
...
public class ExportBase {
	private static final Logger logger = Logger.getLogger(ExportBase.class);
...
//			logger.info("entity.getReplace().length "+entity.getReplace().length+"entity.getReplace()"+entity.getReplace());
