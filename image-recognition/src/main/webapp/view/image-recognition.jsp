...
<body>
<h2>【本地jar包加到本地仓库】</h2>
<form  name="form" id="form"  action="${basePath}/image/uploadImages" method="post" >
    <div style="padding-left: 10px;">
        <div style="width: 100%;padding-bottom: 5px;" class="form-group">
            <label>1. jar包所在路径：</label>
            <input name="images" id="images" type="file" style="margin-bottom:10px;" />
