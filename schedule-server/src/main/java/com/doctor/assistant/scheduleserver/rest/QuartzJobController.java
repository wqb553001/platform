 ...
 */
package com.doctor.assistant.scheduleserver.rest;
...
//    @Log("新增定时任务")
    ...
    public ResponseEntity<Object> create(@Validated @RequestBody QuartzJobEntity resources){
...
//    @Log("修改定时任务")
    ...
    public ResponseEntity<Object> update(@Validated(QuartzJobEntity.Update.class) @RequestBody QuartzJobEntity resources){
...
//        System.out.println(workerCountOf(9));
//        System.out.println(workerCountOf(536870911));
//        System.out.println(workerCountOf(536870912));
//        System.out.println(workerCountOf(536870913));
//        System.out.println(workerCountOf(536870914));
//        System.out.println(7&4);
//        System.out.println(runStateOf(536870913));
        double v = 3 * 0.1;
        double v1 = 0.3;
